...
/* QEMU 10.2.1 compatibility stubs for functions added in QEMU 11.0 */
static Chardev *debug_port_get_chardev(void)
{
    return NULL;
}

static PCIDevice *pci_vga_new(void)
{
    ...
    case VGA_STD:
        return pci_new(-1, "VGA");
    case VGA_VMWARE:
        return pci_new(-1, "vmware-svga");
    default:
        return NULL;
    }
}
