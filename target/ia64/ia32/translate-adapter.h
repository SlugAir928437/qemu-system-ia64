...
/*
 * Redirect i386 helper calls that conflict with IA-64 helpers of the same
 * name.  The ia64 helper.h renames these to ia32_* when including
 * target/i386/helper.h, but the i386 translator code calls gen_helper_*
 * directly.  Redirect those calls to the ia32 versions.
 */
#define gen_helper_rsm gen_helper_ia32_rsm
#define gen_helper_raise_exception gen_helper_ia32_raise_exception
